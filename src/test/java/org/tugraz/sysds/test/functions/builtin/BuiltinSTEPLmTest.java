...
public class BuiltinSTEPLmTest extends AutomatedTestBase{
    ...
    public void testLmMatrixDenseCPlm() {
        runLmTest(false, ExecType.CP, BuiltinLmTest.LinregType.AUTO);
    }

    @Test
    public void testLmMatrixDenseSPlm() {
        runLmTest(false, ExecType.SPARK, BuiltinLmTest.LinregType.AUTO);
    }

    @Test
    public void testLmMatrixSparseSPlm() {
        runLmTest(true, ExecType.SPARK, BuiltinLmTest.LinregType.AUTO);
    }

    @Test
    public void testLmMatrixDenseCPlmDS() {
        runLmTest(false, ExecType.CP, BuiltinLmTest.LinregType.DS);
    }

    @Test
    public void testLmMatrixSparseCPlmDS() {
        runLmTest(true, ExecType.CP, BuiltinLmTest.LinregType.DS);
    }

    @Test
    public void testLmMatrixDenseSPlmDS() {
        runLmTest(false, ExecType.SPARK, BuiltinLmTest.LinregType.DS);
    }

    @Test
    public void testLmMatrixSparseSPlmDS() {
        runLmTest(true, ExecType.SPARK, BuiltinLmTest.LinregType.DS);
    }

    @Test
    public void testLmMatrixDenseCPlmCG() {
        runLmTest(false, ExecType.CP, BuiltinLmTest.LinregType.CG);
    }

    @Test
    public void testLmMatrixSparseCPlmCG() {
        runLmTest(true, ExecType.CP, BuiltinLmTest.LinregType.CG);
    }

    @Test
    public void testLmMatrixDenseSPlmCG() {
        runLmTest(false, ExecType.SPARK, BuiltinLmTest.LinregType.CG);
    }

    @Test
    public void testLmMatrixSparseSPlmCG() {
        runLmTest(true, ExecType.SPARK, BuiltinLmTest.LinregType.CG);
    }

    private void runLmTest(boolean sparse, ExecType instType, BuiltinLmTest.LinregType linregAlgo)
    {
