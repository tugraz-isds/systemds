...
public class DetectSchemaTest extends AutomatedTestBase
{
    ...
    @Test
    public void testDetectSchemaCP() {
        runDetectSchemaTest( DATASET1, 120, 5, true, ExecType.CP  );
    }

    @Test
    public void testDetectSchemaSpark() {
        runDetectSchemaTest(DATASET1, 120, 5, true, ExecType.SPARK);
    }

    @Test
    public void testDetectSchemaCPD2() {
        runDetectSchemaTest( DATASET2, 32561, 15, false, ExecType.CP   );
    }

    @Test
    public void testDetectSchemaSparkD2() {
        runDetectSchemaTest(DATASET2, 32561, 15, false, ExecType.SPARK);
    }

    private void runDetectSchemaTest( String dataset, int rows, int cols, boolean header, ExecType et  )
    {
