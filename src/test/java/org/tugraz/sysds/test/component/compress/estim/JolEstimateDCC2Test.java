...
public class JolEstimateDCC2Test {
	...
	public static Collection<Object[]> data() {
		...
		// tests.add(new Object[] {TestUtils.round(TestUtils.generateTestMatrix(4000, 1, 0, 255, 0.01, 7)),(int)
		// Math.min(4000 * 0.01,256), 50});
	...
	public JolEstimateDCC2Test(double[][] input, int numDistinct, int tolerance) {
		this.input = input;
	...
	public void instanceSize() {
		try {
			...
			ColGroupDDC2 cgU = new ColGroupDDC2(new int[] {0}, input.length, ubm);
			...
			for(Object ob : new Object[] {cgU, new int[] {0}, new double[numDistinct], new char[input.length]}) {
