...
public class DMLOptions {
	...
	public LineageCacheConfig.ReuseOptions LinReuseType = LineageCacheConfig.ReuseOptions.NONE;
				...
				for (String lineageType : lineageTypes) {
					if (lineageType != null){
						if (lineageType.equalsIgnoreCase("dedup"))
							...
							dmlOptions.LinReuseType = LineageCacheConfig.ReuseOptions.REUSE_FULL;
						else if (lineageType.equalsIgnoreCase("reuse_partial"))
							dmlOptions.LinReuseType = LineageCacheConfig.ReuseOptions.REUSE_PARTIAL;
						else if (lineageType.equalsIgnoreCase("reuse_hybrid"))
							dmlOptions.LinReuseType = LineageCacheConfig.ReuseOptions.REUSE_HYBRID;
						else
