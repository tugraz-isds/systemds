...
public class LineageCache {
	...
	public static void put(Instruction inst, ExecutionContext ec) {
		...
		if (inst instanceof ComputationCPInstruction &&
			...
			for (LineageItem item : items) {
				...
				LineageCache.put(inst, item, mo.acquireRead());
				mo.release();
			}
		}
	}
	
	public static void put(Instruction inst, LineageItem key, MatrixBlock value) {
	...
	public static MatrixBlock get(Instruction inst, LineageItem key) {
