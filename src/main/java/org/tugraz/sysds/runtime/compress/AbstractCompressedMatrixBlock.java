...
public abstract class AbstractCompressedMatrixBlock extends MatrixBlock {
	...
	public abstract MatrixBlock compress();
	...
	public long estimateOriginalSizeInMemory(int nrows, int ncols, double sparsity) {
		...
		size += 4; // rlen
		size += 4; // clen
		size += 1; // INCORRECT 0.125 is correct (boolean)
		size += 8; // NonZeros.
