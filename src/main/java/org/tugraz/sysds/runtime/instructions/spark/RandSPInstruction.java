...
public class RandSPInstruction extends UnarySPInstruction {
	...
	private RandSPInstruction(Operator op, DataGenMethod mthd, CPOperand in, CPOperand out, CPOperand rows,
	                          ...
	                          double sparsity, long seed, String dir, String probabilityDensityFunction,
	                          String pdfParams, CPOperand seqFrom, CPOperand seqTo, CPOperand seqIncr, boolean replace,
	...
	private RandSPInstruction(Operator op, DataGenMethod mthd, CPOperand in, CPOperand out, CPOperand rows,
	                          CPOperand cols, CPOperand dims, int rpb, int cpb, String minValue, String maxValue,
	                          double sparsity, long seed, String dir, String probabilityDensityFunction,
	                          String pdfParams, String opcode, String istr) {
	...
	private RandSPInstruction(Operator op, DataGenMethod mthd, CPOperand in, CPOperand out, CPOperand rows,
	                          CPOperand cols, CPOperand dims, int rpb, int cpb, String maxValue, boolean replace,
	...
	public static RandSPInstruction parseInstruction(String str) {
		...
		if ( method == DataGenMethod.RAND ) {
			...
			return new RandSPInstruction(op, method, null, out, rows, cols, dims, rpb, cpb, s[6], s[7], sparsity,
			...
			CPOperand in = null;
			return new RandSPInstruction(op, method, in, out, null, null, null, rpb, cpb, from, to, incr,
					opcode, str);
		}
		else if ( method == DataGenMethod.SAMPLE) 
		{
			...
			return new RandSPInstruction(op, method, null, out, rows, cols, null, rpb, cpb, max, replace, seed,
					opcode, str);
		}
		else 
	...
	private static class GenerateRandomTensorBlock implements PairFunction<Tuple2<TensorIndexes, Long>, TensorIndexes, TensorBlock>
	{
		...
		public GenerateRandomTensorBlock(ValueType vt, int[] dims, int[] blen, double sparsity, String min, String max,
		                           String pdf, String pdfParams) {
			_vt = vt;
