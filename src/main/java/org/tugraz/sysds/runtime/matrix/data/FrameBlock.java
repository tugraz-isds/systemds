...
public class FrameBlock implements Writable, CacheBlock, Externalizable  
{
	...
	public static FrameBlock mergeSchema(FrameBlock temp1, FrameBlock temp2) {
		...
		String[] rowTemp2 = temp1.getStringRowIterator().next();

		if(rowTemp1.length != rowTemp2.length)
		{ System.out.println("schema mismatch");
			System.exit(1); }

		ValueType[] outputSchema = UtilFunctions.nCopies(temp1.getNumColumns(), ValueType.STRING);
		...
		FrameBlock mergedFrame = new FrameBlock(outputSchema);
